      ...
      <main className="flex-grow flex flex-col justify-center">
        ...
        {activeTheme === 'spinner' && (
          <div className="w-full px-6 sm:px-12 lg:px-20 flex-grow flex flex-col justify-between max-w-[1920px] mx-auto py-8 animate-fade-in">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center justify-center w-full min-h-[calc(100vh-220px)]">
              ...
              <div className="lg:col-span-6 flex items-center justify-center relative overflow-visible my-auto">
